    ...
    <div id="contents_wrapper">
        ...
        <div class="panel panel-default" id="video_select" style="display: none">
            <div class="panel-heading">
                <input type="text" id = "input_project_title" name="" value="" placeholder="프로젝트명"/>
                <hr>
...
<script>
    ...
    loadProjectList(1); //프로젝트 리스트를 불러온다 (by user_id :1)
    ...
    $(document).ready(function(){
      $( document ).ajaxSend(function() {
        ...
        var methodName = data.cmd + 'Success'; //원래 함수 뒤에 Success를 붙힌 함수 호출
        if (self[methodName]){
    ...
    //<--------------Trigger Ajax call back function END------------->>
    ...
    //<---------------프로젝트 리스트 LOAD-------------->>
      ...
      //프로젝트 리스트 LOAD Success시 Callback
    ...
    //<---------------미디어 리스트 LOAD-------------->>
      ...
      //미디어 리스트 LOAD Success시 Callback
